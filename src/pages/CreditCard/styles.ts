...
export const ContainerCreditCardConfirmation = styled.div`
  width: 568px;
  height: 214px;
...
export const SpanSuccessfulPayment = styled.span`
  text-align: left;
  font: normal normal bold 22px/27px sans-serif;
  letter-spacing: 0px;
  color: #f4e426;
...
export const SpanPaymentConfirmation = styled.span`
  text-align: center;
  font: normal normal normal 16px/19px sans-serif Lato;
  letter-spacing: 0px;
  color: #ffffff;
  opacity: 1;
`;
